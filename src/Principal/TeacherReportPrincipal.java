...
/**
 * class to present teacher reports for principal user
 * 
 * @author Bashar Ali & Samr Arkab
 */
public class TeacherReportPrincipal {
	@FXML
	...
	private void initialize() {
		...
		graphNameLabel.setText(ReportsBoundary.Teachername);
	...
	/**
	 * starts the teacher reports screen for principal user
	 * 
	 * @param primaryStage Stage object
	 * @throws Exception in case starting the stage was unsuccessful
	 */
	public void start(Stage primaryStage) throws Exception {
		Parent root = FXMLLoader.load(getClass().getResource("/Principal/PrincipalTeacherReport.fxml"));
		Scene scene = new Scene(root);
		primaryStage.getIcons().add(new Image(getClass().getResourceAsStream("/logo.png")));
		primaryStage.setTitle("Principal teacher report form");
